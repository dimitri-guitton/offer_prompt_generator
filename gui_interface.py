...
def copier_reponse():
    """
    Copie la réponse dans le presse-papier.
    """
    fenetre.clipboard_clear()
    fenetre.clipboard_append(txt_prompt.get("1.0", tk.END).strip())
    messagebox.showinfo("Information", "Réponse copiée dans le presse-papier.")
...
# Bouton pour copier la réponse dans le presse-papier
btn_copier = tk.Button(fenetre, text="Copier la réponse", command=copier_reponse)
